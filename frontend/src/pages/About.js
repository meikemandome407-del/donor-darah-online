  ...
  return (
    <div className="container" style={{ paddingBottom: '5rem' }}>
      ...
      <div className="hero" style={{
        ...
        <h1 style={{ fontSize: '3rem', fontWeight: '800', marginBottom: '1rem', background: 'linear-gradient(135deg, #d32f2f, #e53935)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem', marginBottom: '4rem' }}>
        <div className="card" style={{ padding: '2rem', borderRadius: '24px', textAlign: 'center', transition: 'transform 0.3s ease' }} onMouseEnter={e => e.currentTarget.style.transform = 'translateY(-10px)'} onMouseLeave={e => e.currentTarget.style.transform = 'translateY(0)'}>
          ...
          <h3 style={{ fontSize: '1.4rem', color: '#d32f2f', marginBottom: '0.8rem' }}>Radar Geolokasi (Haversine)</h3>
        ...
        <div className="card" style={{ padding: '2rem', borderRadius: '24px', textAlign: 'center', transition: 'transform 0.3s ease' }} onMouseEnter={e => e.currentTarget.style.transform = 'translateY(-10px)'} onMouseLeave={e => e.currentTarget.style.transform = 'translateY(0)'}>
          ...
          <h3 style={{ fontSize: '1.4rem', color: '#d32f2f', marginBottom: '0.8rem' }}>Matriks Kompatibilitas</h3>
          <p style={{ color: '#747d8c', fontSize: '0.95rem', lineHeight: '1.6' }}>
        ...
        <div className="card" style={{ padding: '2rem', borderRadius: '24px', textAlign: 'center', transition: 'transform 0.3s ease' }} onMouseEnter={e => e.currentTarget.style.transform = 'translateY(-10px)'} onMouseLeave={e => e.currentTarget.style.transform = 'translateY(0)'}>
          <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>⏳</div>
          <h3 style={{ fontSize: '1.4rem', color: '#d32f2f', marginBottom: '0.8rem' }}>Filter Pemulihan 90 Hari</h3>
          <p style={{ color: '#747d8c', fontSize: '0.95rem', lineHeight: '1.6' }}>
        ...
        <div className="card" style={{ padding: '2rem', borderRadius: '24px', textAlign: 'center', transition: 'transform 0.3s ease' }} onMouseEnter={e => e.currentTarget.style.transform = 'translateY(-10px)'} onMouseLeave={e => e.currentTarget.style.transform = 'translateY(0)'}>
          <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>✉️</div>
          <h3 style={{ fontSize: '1.4rem', color: '#d32f2f', marginBottom: '0.8rem' }}>SOS Email Darurat Otomatis</h3>
          <p style={{ color: '#747d8c', fontSize: '0.95rem', lineHeight: '1.6' }}>
      ...
      <div className="card" style={{ padding: '3rem 2rem', borderRadius: '30px', background: 'linear-gradient(135deg, white, #f8f9fa)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', maxWidth: '800px', margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1.5rem', background: 'white', padding: '1.5rem', borderRadius: '20px', boxShadow: '0 5px 20px rgba(0,0,0,0.03)' }}>
            <div style={{ width: '50px', height: '50px', borderRadius: '50%', background: '#d32f2f', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 'bold', flexShrink: 0 }}>1</div>
            <div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1.5rem', background: 'white', padding: '1.5rem', borderRadius: '20px', boxShadow: '0 5px 20px rgba(0,0,0,0.03)' }}>
            <div style={{ width: '50px', height: '50px', borderRadius: '50%', background: '#d32f2f', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 'bold', flexShrink: 0 }}>2</div>
            <div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1.5rem', background: 'white', padding: '1.5rem', borderRadius: '20px', boxShadow: '0 5px 20px rgba(0,0,0,0.03)' }}>
            <div style={{ width: '50px', height: '50px', borderRadius: '50%', background: '#d32f2f', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 'bold', flexShrink: 0 }}>3</div>
            <div>
